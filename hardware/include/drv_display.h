...
typedef struct
{
	unsigned int          addr[3];    // frame buffer\B5\C4\C4\DA\C8ݵ\D8ַ\A3\AC\B6\D4\D3\DArgb\C0\E0\D0ͣ\ACֻ\D3\D0addr[0]\D3\D0Ч
	disp_size             size;//\B5\A5λ\CA\C7pixel
...
typedef struct
{
    ...
    unsigned char             zorder;     //layer priority,can get layer prio,but never set layer prio,\B4ӵ\D7\D6\C1\B6\A5,\D3\C5\CFȼ\B6\D3ɵ\CD\D6\C1\B8\DF

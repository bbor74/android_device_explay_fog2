...
BOARD_KERNEL_CMDLINE := console=ttyS0,115200 rw init=/init loglevel=4 androidboot.hardware=sun8i androidboot.selinux=enforcing
...
BOARD_CACHEIMAGE_PARTITION_SIZE := 566231040
